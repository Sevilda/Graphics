...
void init_entities(World* world){
	...
	world->skybox.texture[0] = load_texture("textures//water.png");
	world->skybox.texture[1]= load_texture("textures\\sky.png");	
	world->skybox.texture[2]= load_texture("textures\\sky.png");	
	world->skybox.texture[3]= load_texture("textures\\sky.png");	
	world->skybox.texture[4]= load_texture("textures\\sky.png");	
	world->skybox.texture[5]= load_texture("textures\\sky.png");	
	...
	//Load the boat
	load_model("objects\\boat.obj", &world->boat.model);
	world->boat.texture[0]= load_texture("textures\\boat1.jpg");
	world->boat.texture[1] = load_texture("textures\\boat2.jpg");

	//Load the treasure chest
	load_model("objects\\chest.obj", &world->chest.model);
	world->chest.texture= load_texture("textures\\chest.png");
}
